                ...
                <p class="my-5">
                    ...
                    <div x-data="{ open: false }" id="applicant-form">
                        <button
                            ...
                            border text-base font-medium cursor-pointer text-indigo-700
                        ...
                        <div x-cloak x-show="open" class="fixed inset-0 flex items-center justify-center bg-gray-900 bg-opacity-50">
                            <div @click.away="open = false" class="bg-white p-6 rounded-lg shadow-md w-full max-w-md">
                                ...
                                <form method="POST" action="{{route('applicant.store', $job->id)}}" enctype="multipart/form-data">
                                    @csrf
                                    <x-text id="full_name" name="full_name" label="Full Name" :required="true" />

                                    <x-text id="contact_phone" name="contact_phone" label="Contact Phone" />

                                    <x-text id="contact_email" name="contact_email" label="Contact Email" type="email" :required="true" />

                                    <x-text-area id="message" name="message" label="Message" />

                                    <x-text id="location" name="location" label="Location" />

                                    <x-file  id="resume" name="resume" label="Upload Resume(pdf)" :required="true" />
                                    ...
                                    <button
                                        @click="open = false"
                                        class="bg-gray-300 hover:bg-blue-400 text-black py-2 px-4 rounded-md"
                                    >
                                        Cancel
                                    </button>
                                </form>
                    ...
                    @else
                        <p class="bg-gray-400 rounded p-3 my-5">
